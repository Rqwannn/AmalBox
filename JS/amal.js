...
$.ajax({
  ...
  success: function (result) {
    ...
    let getProgress = Math.round(
      (parseInt(result.data.terkumpul) * 100) / parseInt(result.data.dana)
    );
    ...
    let terkumpul = Formater.toRupiah(result.data.terkumpul);

    if (result.data.terkumpul == 0) {
      terkumpul = "Rp. 0";
    }
