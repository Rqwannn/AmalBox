...
<body>
                ...
                <div class="col-md-3">
                    <div class="sidebar">
                        <ul class="widget widget-menu unstyled" style="list-style-type: none;padding:0;">
                            ...
                            <li><a href="<?= BASE_URL; ?>/add-amal.php"><i class="menu-icon icon-dashboard"></i>Tambah Amal
                                </a></li>
                    ...
                    <div class="content">
                        ...
                        <div class="form-horizontal btn-box row-fluid text-left">
                            <div class="row px-5">
                                ...
                                <div class="col-md-6 mb-3 ">
                                    <label class="control-label" for="basicinput">Gambar Lama 1</label>
                                    <div class="controls">
                                        <img src="#" id="FileLama1" class="mt-2" width="150">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 ">
                                    <label class="control-label" for="basicinput">Gambar Lama 2</label>
                                    <div class="controls">
                                        <img src="#" id="FileLama2" class="mt-2" width="150">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-primary" onclick="EditAmal()" type="submit" style="margin-top: 20px;">Tambah</button>
                                </div>
                            </div>
                        </div>
                        <!--/.module-->
    ...
    <script src="<?= BASE_URL; ?>/js/editAmal.js" type="text/javascript"></script>
