                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li ><a href="add-amal.html"><i class="menu-icon icon-dashboard"></i>Tambah Amal
                                </a></li>
                        ...
                        <div class="content">
                            ...
                            <form class="form-horizontal btn-box row-fluid">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="username" placeholder="Username" class="span6">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="email">Email</label>
                                    <div class="controls">
                                        <input type="text" id="email" placeholder="Email" class="span6">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="password">Password</label>
                                    <div class="controls">
                                        <input type="password" id="password" placeholder="Password" class="span6">
                                    </div>>
                                </div>
